...
export default function Experience() {
  const data = [
    {
      year: "Des 2025 - Now",
      title:
        "Mobile App Developer - PT Tiga Serangkai Pustaka Mandiri (MagangHub)",
    ...
    },
    {
      ...
      title:
        "MSIB Kampus Merdeka Batch 7 – Cloud Computing Cohort Bangkit Academy 2024 Graduate",
      location: "Remote",
      logo: "/bangkit.png",
  ...
  return (
    <section id="experience" className="relative min-h-screen py-24 pb-40 px-6">
